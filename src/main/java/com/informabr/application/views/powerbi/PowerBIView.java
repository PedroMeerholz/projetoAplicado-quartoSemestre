...
public class PowerBIView extends Main implements HasComponents, HasStyle {
    ...
    public PowerBIView() {
        ...
        imageContainer.add(new PowerBIViewCard("Documentação Swagger",
                "https://i.postimg.cc/K85JvMgk/sw-agger.png", "Documentação Swagger", "Caso possua alguma dúvida em relação ao uso do Swagger, obtenha ajuda aqui", "window.open('http://52.12.100.76:8090//swagger-ui.html');"));
    }
